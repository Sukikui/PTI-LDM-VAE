#!/usr/bin/env python
"""
UMAP Analysis of VAE Latent Space

This script performs UMAP dimensionality reduction on the latent space
of a trained VAE model and visualizes the results for comparative analysis
between different image groups (e.g., edentulous vs. dental images).
"""
...
def main():
    ...
    latent_vectors_list = [(latent_group1, ids_group1, "group1")]
    ...
    if args.folder_group2:
        ...
        latent_vectors_list.append((latent_group2, ids_group2, "group2"))
    ...
    if args.folder_group2:
        # Transform group 2 using fitted UMAP model
    ...
    if args.folder_group2:
        ...
        title = f"UMAP: {group1_name} (o) vs {group2_name} (^)"
    else:
        title = f"UMAP: {group1_name}"
    ...
    # Plot
    save_path = output_dir / "umap_projection.png"
    ...
    if args.folder_group2:
        ...
        projection_data = [
            (umap_group1, ids_group1, group1_name),
            (umap_group2, ids_group2, group2_name)
        ]
        latent_data = [
