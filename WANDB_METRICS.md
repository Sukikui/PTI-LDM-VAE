...
- `train/adv_gen_loss` : perte adversariale du générateur (si activé).
- `train/adv_disc_loss` : perte adversariale du discriminateur (si activé).
...
- `val/adv_gen_loss`, `val/adv_disc_loss` : pertes adversariales moyennes (si activé).
...
- Données : `data_source`, `patch_size`, `train_split`.
