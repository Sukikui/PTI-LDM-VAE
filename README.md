...
- [`docs/architecture.md`](docs/architecture.md): Detailed method description (also embedded below).
...
## Architecture (embedded from docs/architecture.md)
...
![VAE and Regression Head Training Loops](docs/figures/vae_regression_training_loop.svg#gh-light-mode-only)
![VAE and Regression Head Training Loops](docs/figures/vae_regression_training_loop_dark.svg#gh-dark-mode-only)
